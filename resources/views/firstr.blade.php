	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('img/opol.jpg');">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="{{URL::to('/store')}}"  method="post">
					@csrf
					@csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter username" >
						<input class="input100" type="text" required="required" name="username" placeholder="Enter User name">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
                   
                     
                       <div class="wrap-input100 validate-input" data-validate = "Enter username" >
						<input class="input100" type="integer"  name="registration_num" placeholder="Enter Registration number">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>


					<div class="wrap-input100 validate-input" data-validate = "Enter username" >
						<input class="input100" type="text"  required="required" name="email" placeholder="email">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
